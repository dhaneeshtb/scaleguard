...
export default function Landing() {
  ...
  return (
    <AnimatePresence>
      <div className="min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-auto">
        <svg
        ...
        <main className="flex flex-col justify-center h-[90%] static w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          {/* <motion.svg
          ...
          <motion.div
            ...
            className="block  row-start-2 mb-8 md:mb-6 text-[16vw] md:text-[50px] leading-[0.9] tracking-[-2px]"
            
          >
            <div className="flex items-center"><img className="h-[100px]" src="/lb.svg"></img><p>Scaleguard</p></div>
          </motion.div>
          ...
          >
            Scale your infrstructure  <br /> <span className="text-[#407BBF]">10X</span>
            <span className="font-inter text-[#407BBF]">.</span>
          </motion.h1>
          <div className="flex gap-[15px] mt-8 md:mt-0 mb-10">
            <motion.div
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{
          ...
          <motion.div
            ...
            className="grid grid-cols-2 justify-center z-20 mx-0 mb-0 mt-8 md:mt-0 md:mb-[35px] max-w-2xl gap-3"
          >


                  <div className="p-6  rounded-md shadow-md font-semibold text-[1em] text-[#1a2b3b] ">
                    <h3 className="text-xl font-semibold mb-4 text-left" >Automatic Certificate Provisioning</h3>
                    <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">Automated provisioning and management of SSL/TLS certificates for secure communication.</p>
                  </div>

                  <div className="p-6 rounded-md shadow-md font-semibold text-[1em] text-[#1a2b3b]">
                    <h3 className="text-xl font-semibold mb-4 text-left">Request Caching</h3>
                    <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">Store frequently requested content at the load balancer level to improve response times and reduce load on backend servers.</p>
                  </div>

                  <div className="p-6 rounded-md shadow-md font-semibold text-[1em] text-[#1a2b3b]">
                    <h3 className="text-xl font-semibold mb-4 text-left">Async API Support</h3>
                    <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">Efficiently handle asynchronous communication patterns for real-time applications or services.</p>
                  </div>


<div className="p-6 p-6 rounded-md shadow-md font-semibold text-[1em] text-[#1a2b3b]">
                    <h2 className="text-xl font-semibold mb-4 text-md text-left ">High Scalability</h2>
                    <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">Efficiently handle a large number of concurrent connections and scale horizontally as demand increases.</p>
                  </div>

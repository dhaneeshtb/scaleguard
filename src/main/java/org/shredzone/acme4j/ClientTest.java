...
public class ClientTest {
    ...
    private Order getPreviousOrder() throws AcmeException, IOException {
        ...
        Order order = new Order(acct.getLogin(),new URL("https://acme-staging-v02.api.letsencrypt.org/acme/order/133882704/13951600234"));

        order.setJSON(JSON.parse("{\"status\":\"pending\",\"expires\":\"2024-02-02T08:30:37Z\",\"identifiers\":[{\"type\":\"dns\",\"value\":\"abcd.ambersand.in\"}],\"authorizations\":[\"https://acme-staging-v02.api.letsencrypt.org/acme/authz-v3/10826633184\"],\"finalize\":\"https://acme-staging-v02.api.letsencrypt.org/acme/finalize/133882704/13951600234\"}"));

       // order.rebind(order.getLogin());

        return order;

        // Order the certificate
//        acct.getOrders().forEachRemaining(o->{
//            System.out.println(o.getCertificate().toString()+""+o.getStatus());
//        });
    }
    ...
    public void fetchCertificate(Collection<String> domains) throws IOException, AcmeException {
        ...
        System.out.println(order.getJSON());
...
//        }
    ...
    public void completeChallenge(String message) {
        System.out.println("Challenge completed "+message);
...
//        Collection<String> domains = Arrays.asList(args);
        Collection<String> domains = Arrays.asList(new String[]{"abcd.ambersand.in"});
        try {

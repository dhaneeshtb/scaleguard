 ...
 * under the License.
 */
package com.scaleguard.server.http.dns.dot;
...
public final class DoTClient {
    private static final String QUERY_DOMAIN = "api.github.com";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            DnsQuery query = new DefaultDnsQuery(randomID, DnsOpCode.QUERY)
                    .setRecord(DnsSection.QUESTION, new DefaultDnsQuestion(QUERY_DOMAIN, DnsRecordType.CNAME));
